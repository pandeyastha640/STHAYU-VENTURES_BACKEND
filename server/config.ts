...
export const config = {
  ...
  // Database
  databaseUrl: process.env.DATABASE_URL || path.join(process.cwd(), "sthayu_production.db"),
  ...
  rateLimitMaxRequests: parseInt(process.env.RATE_LIMIT_MAX_REQUESTS || "100", 10), // 100 req/min
  publicFormRateLimitMax: parseInt(process.env.PUBLIC_FORM_RATE_LIMIT_MAX || "10", 10), // 10 submissions/min
